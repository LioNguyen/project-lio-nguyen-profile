...
const defaultTranslations = {
  ...
  about: {
    title: 'Giới Thiệu',
    paragraph1: 'Những năm phổ thông, mình là thành viên đội tuyển Tin học trường THPT chuyên Trần Đại Nghĩa, tham gia vòng chung kết Olympic Tin học và đạt chứng chỉ Microsoft Office Specialist. Nhưng ở ngã rẽ đại học, mình chọn Kế toán & Kiểm toán tại Đại học Ngân hàng TP.HCM. Lúc đó, mình nghĩ mình đang thực tế — chọn sự an toàn thay vì đam mê.',
    
    paragraph2: 'Gần 4 năm làm kế toán, công việc ổn định nhưng mỗi ngày trôi qua, mình cảm thấy khoảng cách ngày càng xa xôi — giữa những gì mình đang làm và những gì mình thực sự muốn làm. Nhìn các lập trình viên xây dựng sản phẩm chạm đến hàng triệu con tim, còn mình chỉ đối chiếu dòng số liệu trên bảng tính. Sợ bắt đầu lại ở tuổi 27, không có bằng cử nhân Khoa học Máy tính chính quy, gần như đã khiến mình muốn dừng lại. "Có quá muộn không? Liệu mình có làm được không?" — những câu hỏi ấy ám ảnh mình đêm này qua đêm khác.',
    
    paragraph3: 'Năm 2021, mình quyết định điều khó khăn nhất: tự học lập trình từ con số không. Những tháng đầu quả thật tàn khốc — thức trắng từng đêm debug code tưởng chừng bất khả thi, xem tutorial mấy chục lần, cứ cảm giác như mình là người duy nhất chẳng hiểu. Có lúc muốn bỏ cuộc — khi một bug mất cả tuần mới sửa, khi phỏng vấn liên tiếp bị từ chối vì "thiếu kinh nghiệm", khi tự hỏi có phải mình đã lãng phí những năm tháng.',
    
    paragraph4: 'Nhưng mình không bỏ cuộc. Chính nền tảng kế toán — thứ mà lúc đó mình nghĩ là bất lợi — lại trở thành vũ khí bí mật. Mình hiểu logic kinh doanh, quy trình người dùng, độ tin cậy hệ thống theo cách mà bootcamp không dạy. Mình học được chia nhỏ vấn đề phức tạp thành từng mảnh ghép — kỹ năng tương tự khi cân đối sổ sách. Từ từ, từng chiến thắng nhỏ, mình xây dựng lại niềm tin. Mỗi bug sửa được, mỗi tính năng chạy trơn, mỗi "eureka!" là bằng chứng: mình làm được!',
    
    paragraph5: 'Hôm nay, sau hơn 4 năm, mình đã chứng minh: không bao giờ quá muộn để theo đuổi thứ mình yêu thích. Hành trình từ kế toán sang lập trình không phải về tài năng thiên bẩm — mà là về kiên trì, xuất hiện mỗi ngày, đặc biệt những ngày tồi tệ nhất. Nếu bạn đang cân nhắc chuyển nghề, học cái gì mới, hay theo đuổi giấc mơ tưởng chừng viễn vông: hãy bắt đầu dù lộn xộn, hãy kiên trì dù khó khăn, hãy tin vào quá trình. Quá khứ không giới hạn bạn — nó đang tôi luyện, chuẩn bị bạn để tỏa sáng.',
  },
